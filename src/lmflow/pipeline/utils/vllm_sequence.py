...
from lmflow.pipeline.utils.vllm_block import LogicalTokenBlock
...
class SequenceGroup:
    ...
    Args:
        ...
        inferencer_args: The inferencer arguments.
    ...
    def get_max_num_running_seqs(self) -> int:
        ...
        if self.inferencer_args.use_beam_search:
            # For beam search, maximally there will always be `best_of` beam
            # candidates running in the future.
            return self.inferencer_args.num_beams
        else:
            if self.inferencer_args.num_beams > self.num_seqs():
    ...
    def __repr__(self) -> str:
        return (f"SequenceGroup(request_id={self.request_id}, "
                f"inferencer_args={self.inferencer_args}, "
